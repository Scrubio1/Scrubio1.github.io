...
- Repalaced index page icons for individual toosl with consistent ones
...
- UX enhancement based on Amy's suggestion. The new and switching scenario can only occur in October so I limited the drop-down options in the "First Month of Coverage" to November and December".

*See commit notes for actions prior to 05-11-2026*
